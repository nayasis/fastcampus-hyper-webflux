...
import dev.fastcampus.payment.config.extension.toLocalDate
...
class OrderHistoryServiceTest(
    ...
    "get order history" {
        ...
        listOf(
            Order(userId = 11, description = "A,B",     amount = 1000), // 2023-01-01
            Order(userId = 11, description = "C",       amount = 1100), // 2023-01-02
            Order(userId = 11, description = "D,E,F",   amount = 1200), // 2023-01-03
            Order(userId = 11, description = "D,G,H",   amount = 1300), // 2023-01-04
            Order(userId = 11, description = "I,J",     amount = 1400), // 2023-01-05
            Order(userId = 11, description = "I,K",     amount = 1500), // 2023-01-06
            Order(userId = 11, description = "I,L,M",   amount = 1600), // 2023-01-07
            Order(userId = 11, description = "I,L,M,N", amount = 1700), // 2023-01-08
            Order(userId = 11, description = "O",       amount = 1800), // 2023-01-09
            Order(userId = 11, description = "P,Q",     amount = 1900), // 2023-01-10
            Order(userId = 11, description = "P,R",     amount = 2000), // 2023-01-11
        ).forEach {
...
//        orderRepository.findAll().toList().let { logger.debug { it.joinToString("\n") } }
        ...
        orderHistoryService.getHistories(QryOrderHistory(userId=11, fromDate="2023-01-03")).size shouldBe 9
        orderHistoryService.getHistories(QryOrderHistory(userId=11, fromDate="2023-01-03", toDate="2023-01-08")).size shouldBe 6
